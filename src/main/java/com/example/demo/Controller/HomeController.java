...
import com.example.demo.Contacts12Application;
...
public class HomeController {
	...
	public boolean sendMail(String msg, String sub, String to, String from) throws MessagingException {
		...
		jakarta.mail.Session ses = Session.getInstance(p, new Authenticator() {

			@Override
			protected PasswordAuthentication getPasswordAuthentication() {
				// TODO Auto-generated method stub
				return new PasswordAuthentication("simarp804@gmail.com", "yjyyjrkuoazdrext");
			}
	...
	public String emailSend(@RequestParam("email") String email, HttpSession hs) {
		try {
			...
			mail m = new mail();
			hs.setAttribute("msg", "OTP sent to your Email ID");
			otpCheck = result;
			sendMail("OTP is " + result, "Email Verification", email, "simarp804@gmail.com");
			flag = false;
